...
import { LogIn, AlertCircle, Loader, KeyRound, UserPlus, Mail, Lock, User, Home } from 'lucide-react';
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 animate-fade-in relative">
      <Link 
        to="/" 
        className="absolute top-6 left-6 flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition-colors bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm hover:shadow-md"
      >
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8 animate-fade-in flex flex-col items-center">
          <ExpandableLogo className="h-24 w-auto object-contain mb-4 animate-bounce-subtle hover-lift rounded-xl shadow-lg" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden animate-scale-in delay-3 hover-lift">
          ...
          <div className="p-8">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6 animate-slide-in delay-1">
              ...
              {view === 'register' && 'Join UZHAMI to manage your farm'}
