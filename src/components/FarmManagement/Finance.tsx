...
import { DollarSign, Plus, Search, Filter, Calendar, X, Loader, BarChart, TrendingUp, Download, PieChart, AlertCircle } from 'lucide-react';
...
`).join('\n')}`;
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {error && (
        <div className="mb-6 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400 p-4 rounded-lg flex items-center justify-between">
